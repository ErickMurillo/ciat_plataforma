...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EstimadoCosechaMaiz2.peso_promedio'
        db.delete_column(u'ficha_granos_basicos_estimadocosechamaiz2', 'peso_promedio')

        # Adding field 'EstimadoCosechaMaiz2.nnumero_granos'
        db.add_column(u'ficha_granos_basicos_estimadocosechamaiz2', 'nnumero_granos',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TablaGastos.dias_persona'
        db.delete_column(u'ficha_granos_basicos_tablagastos', 'dias_persona')

        # Adding field 'TablaGastos.dias_persona_familiar'
        db.add_column(u'ficha_granos_basicos_tablagastos', 'dias_persona_familiar',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TablaGastos.dias_persona_contratado'
        db.add_column(u'ficha_granos_basicos_tablagastos', 'dias_persona_contratado',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EstimadoCosechaMaiz2.peso_promedio'
        db.add_column(u'ficha_granos_basicos_estimadocosechamaiz2', 'peso_promedio',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'EstimadoCosechaMaiz2.nnumero_granos'
        db.delete_column(u'ficha_granos_basicos_estimadocosechamaiz2', 'nnumero_granos')

        # Adding field 'TablaGastos.dias_persona'
        db.add_column(u'ficha_granos_basicos_tablagastos', 'dias_persona',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'TablaGastos.dias_persona_familiar'
        db.delete_column(u'ficha_granos_basicos_tablagastos', 'dias_persona_familiar')

        # Deleting field 'TablaGastos.dias_persona_contratado'
        db.delete_column(u'ficha_granos_basicos_tablagastos', 'dias_persona_contratado')
