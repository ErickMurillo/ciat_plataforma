...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Especies.control_biologico'
        db.alter_column(u'ficha_granos_basicos_especies', 'control_biologico', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Especies.dano1'
        db.alter_column(u'ficha_granos_basicos_especies', 'dano1', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Especies.control_cultural'
        db.alter_column(u'ficha_granos_basicos_especies', 'control_cultural', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Especies.reconocimiento'
        db.alter_column(u'ficha_granos_basicos_especies', 'reconocimiento', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Especies.control_quimico'
        db.alter_column(u'ficha_granos_basicos_especies', 'control_quimico', self.gf('ckeditor.fields.RichTextField')(null=True))
        # Adding field 'Visitas.anio'
        db.add_column(u'ficha_granos_basicos_visitas', 'anio',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Especies.control_biologico'
        db.alter_column(u'ficha_granos_basicos_especies', 'control_biologico', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Especies.dano1'
        db.alter_column(u'ficha_granos_basicos_especies', 'dano1', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Especies.control_cultural'
        db.alter_column(u'ficha_granos_basicos_especies', 'control_cultural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Especies.reconocimiento'
        db.alter_column(u'ficha_granos_basicos_especies', 'reconocimiento', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Especies.control_quimico'
        db.alter_column(u'ficha_granos_basicos_especies', 'control_quimico', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Deleting field 'Visitas.anio'
        db.delete_column(u'ficha_granos_basicos_visitas', 'anio')
