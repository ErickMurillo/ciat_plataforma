...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Monitoreo.ciclo_productivo'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'ciclo_productivo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.nombre_parcela'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'nombre_parcela',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.edad_parcela'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'edad_parcela',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.latitud'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'latitud',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.longitud'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'longitud',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.direccion_viento'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'direccion_viento',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.percepcion_fertilidad'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'percepcion_fertilidad',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.tamano_parcela'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'tamano_parcela',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.profundidad_capa'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'profundidad_capa',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.acceso_agua'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'acceso_agua',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.fuente_agua'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'fuente_agua',
                      self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=7, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Monitoreo.distancia'
        db.add_column(u'ficha_granos_basicos_monitoreo', 'distancia',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'DatosMonitoreo.ciclo_productivo'
        db.delete_column(u'ficha_granos_basicos_datosmonitoreo', 'ciclo_productivo')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Monitoreo.ciclo_productivo'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'ciclo_productivo')

        # Deleting field 'Monitoreo.nombre_parcela'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'nombre_parcela')

        # Deleting field 'Monitoreo.edad_parcela'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'edad_parcela')

        # Deleting field 'Monitoreo.latitud'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'latitud')

        # Deleting field 'Monitoreo.longitud'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'longitud')

        # Deleting field 'Monitoreo.direccion_viento'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'direccion_viento')

        # Deleting field 'Monitoreo.percepcion_fertilidad'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'percepcion_fertilidad')

        # Deleting field 'Monitoreo.tamano_parcela'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'tamano_parcela')

        # Deleting field 'Monitoreo.profundidad_capa'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'profundidad_capa')

        # Deleting field 'Monitoreo.acceso_agua'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'acceso_agua')

        # Deleting field 'Monitoreo.fuente_agua'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'fuente_agua')

        # Deleting field 'Monitoreo.distancia'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'distancia')

        # Deleting field 'Monitoreo.anio'
        db.delete_column(u'ficha_granos_basicos_monitoreo', 'anio')

        # Adding field 'DatosMonitoreo.ciclo_productivo'
        db.add_column(u'ficha_granos_basicos_datosmonitoreo', 'ciclo_productivo',
    ...
    models = {
        ...
        u'ficha_granos_basicos.monitoreo': {
            ...
            'fecha_monitoreo': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'fuente_agua': ('multiselectfield.db.fields.MultiSelectField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitud': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'longitud': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
