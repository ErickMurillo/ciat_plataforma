...
def notify_all_foro(foros):
    ...
    send_mail('Nuevo Foro en Alianza CAC', contenido, 'alianza.cac@gmail.com', [user.email for user in users if user.email])
...
def notify_all_aporte(aportes):
    ...
    send_mail('Nuevo Aporte en Alianza CAC', contenido, 'alianza.cac@gmail.com', [user.email for user in users if user.email])
...
def notify_user_comentario(comentario):
    ...
    send_mail('Nuevo comentario Alianza CAC', contenido, 'alianza.cac@gmail.com', [comentario.aporte.user.email])
