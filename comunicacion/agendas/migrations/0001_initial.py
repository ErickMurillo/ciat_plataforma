...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'agendas_agendas', (
            ...
            ('publico', self.gf('django.db.models.fields.BooleanField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'agendas', ['Agendas'])


    def backwards(self, orm):
        # Deleting model 'Agendas'
        db.delete_table(u'agendas_agendas')
