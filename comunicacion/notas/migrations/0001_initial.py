...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Temas'
        db.create_table(u'notas_temas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'notas', ['Temas'])

        # Adding model 'Notas'
        db.create_table(u'notas_notas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'notas', ['Notas'])

        # Adding M2M table for field temas on 'Notas'
        m2m_table_name = db.shorten_name(u'notas_notas_temas')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notas', models.ForeignKey(orm[u'notas.notas'], null=False)),
            ('temas', models.ForeignKey(orm[u'notas.temas'], null=False))
        ))
        db.create_unique(m2m_table_name, ['notas_id', 'temas_id'])

        # Adding model 'ComentarioNotas'
        db.create_table(u'notas_comentarionotas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'notas', ['ComentarioNotas'])


    def backwards(self, orm):
        # Deleting model 'Temas'
        db.delete_table(u'notas_temas')

        # Deleting model 'Notas'
        db.delete_table(u'notas_notas')

        # Removing M2M table for field temas on 'Notas'
        db.delete_table(db.shorten_name(u'notas_notas_temas'))

        # Deleting model 'ComentarioNotas'
        db.delete_table(u'notas_comentarionotas')
    ...
    models = {
        ...
        u'notas.comentarionotas': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nota': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['notas.Notas']"}),
        ...
        u'notas.notas': {
            ...
            'temas': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['notas.Temas']", 'symmetrical': 'False'}),
