...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notas.sitio_accion'
        db.add_column(u'notas_notas', 'sitio_accion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['configuracion.SitioAccion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notas.sitio_accion'
        db.delete_column(u'notas_notas', 'sitio_accion_id')
