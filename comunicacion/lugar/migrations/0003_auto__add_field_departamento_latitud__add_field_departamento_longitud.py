...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Departamento.latitud'
        db.add_column(u'lugar_departamento', 'latitud',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5, blank=True),
                      keep_default=False)

        # Adding field 'Departamento.longitud'
        db.add_column(u'lugar_departamento', 'longitud',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Departamento.latitud'
        db.delete_column(u'lugar_departamento', 'latitud')

        # Deleting field 'Departamento.longitud'
        db.delete_column(u'lugar_departamento', 'longitud')
