...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductorGranosBasicos.organizacion'
        db.delete_column(u'mapeo_productorgranosbasicos', 'organizacion_id')

        # Adding M2M table for field organizacion on 'ProductorGranosBasicos'
        m2m_table_name = db.shorten_name(u'mapeo_productorgranosbasicos_organizacion')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productorgranosbasicos', models.ForeignKey(orm[u'mapeo.productorgranosbasicos'], null=False)),
            ('organizaciones', models.ForeignKey(orm[u'mapeo.organizaciones'], null=False))
        ))
        db.create_unique(m2m_table_name, ['productorgranosbasicos_id', 'organizaciones_id'])


    def backwards(self, orm):
        # Adding field 'ProductorGranosBasicos.organizacion'
        db.add_column(u'mapeo_productorgranosbasicos', 'organizacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mapeo.Organizaciones']),
                      keep_default=False)

        # Removing M2M table for field organizacion on 'ProductorGranosBasicos'
        db.delete_table(db.shorten_name(u'mapeo_productorgranosbasicos_organizacion'))
    ...
    models = {
        ...
        u'mapeo.productorgranosbasicos': {
            ...
            'organizacion': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['mapeo.Organizaciones']", 'null': 'True', 'blank': 'True'}),
            'persona': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mapeo.Persona']"}),
