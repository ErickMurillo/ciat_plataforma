...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TecnicoEspInvestigador.correo_electronico'
        db.add_column(u'mapeo_tecnicoespinvestigador', 'correo_electronico',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Decisor.correo_electronico'
        db.add_column(u'mapeo_decisor', 'correo_electronico',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lideres.correo_electronico'
        db.add_column(u'mapeo_lideres', 'correo_electronico',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TecnicoEspInvestigador.correo_electronico'
        db.delete_column(u'mapeo_tecnicoespinvestigador', 'correo_electronico')

        # Deleting field 'Decisor.correo_electronico'
        db.delete_column(u'mapeo_decisor', 'correo_electronico')

        # Deleting field 'Lideres.correo_electronico'
        db.delete_column(u'mapeo_lideres', 'correo_electronico')
