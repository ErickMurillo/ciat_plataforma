...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organizaciones.sector_en'
        db.add_column(u'mapeo_organizaciones', 'sector_en',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configuration.Sector_en'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organizaciones.sector_en'
        db.delete_column(u'mapeo_organizaciones', 'sector_en_id')
