...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductorGranosBasicos.latitud'
        db.delete_column(u'mapeo_productorgranosbasicos', 'latitud')

        # Deleting field 'ProductorGranosBasicos.nombre_finca'
        db.delete_column(u'mapeo_productorgranosbasicos', 'nombre_finca')

        # Deleting field 'ProductorGranosBasicos.longitud'
        db.delete_column(u'mapeo_productorgranosbasicos', 'longitud')

        # Adding field 'ProductorGranosBasicos.latitud1'
        db.add_column(u'mapeo_productorgranosbasicos', 'latitud1',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductorGranosBasicos.longitud1'
        db.add_column(u'mapeo_productorgranosbasicos', 'longitud1',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProductorGranosBasicos.latitud'
        db.add_column(u'mapeo_productorgranosbasicos', 'latitud',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'ProductorGranosBasicos.nombre_finca'
        db.add_column(u'mapeo_productorgranosbasicos', 'nombre_finca',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=200),
                      keep_default=False)

        # Adding field 'ProductorGranosBasicos.longitud'
        db.add_column(u'mapeo_productorgranosbasicos', 'longitud',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'ProductorGranosBasicos.latitud1'
        db.delete_column(u'mapeo_productorgranosbasicos', 'latitud1')

        # Deleting field 'ProductorGranosBasicos.longitud1'
        db.delete_column(u'mapeo_productorgranosbasicos', 'longitud1')
    ...
    models = {
        ...
        u'mapeo.productorgranosbasicos': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitud1': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'longitud1': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
