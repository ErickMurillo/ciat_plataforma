...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TiposProyectos'
        db.create_table(u'mapeo_tiposproyectos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'mapeo', ['TiposProyectos'])

        # Adding model 'Temas'
        db.create_table(u'mapeo_temas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'mapeo', ['Temas'])

        # Adding model 'TimeLineProyecto'
        db.create_table(u'mapeo_timelineproyecto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Proyectos'])),
        ...
        db.send_create_signal(u'mapeo', ['TimeLineProyecto'])

        # Adding field 'Proyectos.descripcion'
        db.add_column(u'mapeo_proyectos', 'descripcion',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Proyectos.tipo'
        db.add_column(u'mapeo_proyectos', 'tipo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.TiposProyectos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Proyectos.encargado'
        db.add_column(u'mapeo_proyectos', 'encargado',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field temas on 'Proyectos'
        m2m_table_name = db.shorten_name(u'mapeo_proyectos_temas')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('proyectos', models.ForeignKey(orm[u'mapeo.proyectos'], null=False)),
            ('temas', models.ForeignKey(orm[u'mapeo.temas'], null=False))
        ))
        db.create_unique(m2m_table_name, ['proyectos_id', 'temas_id'])


    def backwards(self, orm):
        # Deleting model 'TiposProyectos'
        db.delete_table(u'mapeo_tiposproyectos')

        # Deleting model 'Temas'
        db.delete_table(u'mapeo_temas')

        # Deleting model 'TimeLineProyecto'
        db.delete_table(u'mapeo_timelineproyecto')

        # Deleting field 'Proyectos.descripcion'
        db.delete_column(u'mapeo_proyectos', 'descripcion')

        # Deleting field 'Proyectos.tipo'
        db.delete_column(u'mapeo_proyectos', 'tipo_id')

        # Deleting field 'Proyectos.encargado'
        db.delete_column(u'mapeo_proyectos', 'encargado')

        # Removing M2M table for field temas on 'Proyectos'
        db.delete_table(db.shorten_name(u'mapeo_proyectos_temas'))
