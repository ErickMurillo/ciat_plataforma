...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Especies.nombre_cientifico'
        db.add_column(u'guias_cacao_especies', 'nombre_cientifico',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Especies.tipo_uso'
        db.add_column(u'guias_cacao_especies', 'tipo_uso',
                      self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=9, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Especies.nombre_cientifico'
        db.delete_column(u'guias_cacao_especies', 'nombre_cientifico')

        # Deleting field 'Especies.tipo_uso'
        db.delete_column(u'guias_cacao_especies', 'tipo_uso')
