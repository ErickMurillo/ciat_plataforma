...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosechaPunto2.total_platas'
        db.add_column(u'guias_cacao_cosechapunto2', 'total_platas',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CosechaPunto2.contador'
        db.add_column(u'guias_cacao_cosechapunto2', 'contador',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CosechaPunto3.total_platas'
        db.add_column(u'guias_cacao_cosechapunto3', 'total_platas',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CosechaPunto3.contador'
        db.add_column(u'guias_cacao_cosechapunto3', 'contador',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CosechaPunto1.total_platas'
        db.add_column(u'guias_cacao_cosechapunto1', 'total_platas',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CosechaPunto1.contador'
        db.add_column(u'guias_cacao_cosechapunto1', 'contador',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosechaPunto2.total_platas'
        db.delete_column(u'guias_cacao_cosechapunto2', 'total_platas')

        # Deleting field 'CosechaPunto2.contador'
        db.delete_column(u'guias_cacao_cosechapunto2', 'contador')

        # Deleting field 'CosechaPunto3.total_platas'
        db.delete_column(u'guias_cacao_cosechapunto3', 'total_platas')

        # Deleting field 'CosechaPunto3.contador'
        db.delete_column(u'guias_cacao_cosechapunto3', 'contador')

        # Deleting field 'CosechaPunto1.total_platas'
        db.delete_column(u'guias_cacao_cosechapunto1', 'total_platas')

        # Deleting field 'CosechaPunto1.contador'
        db.delete_column(u'guias_cacao_cosechapunto1', 'contador')
