...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VivieroObservacion2.total_si'
        db.add_column(u'guias_cacao_vivieroobservacion2', 'total_si',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VivieroObservacion2.total_si'
        db.delete_column(u'guias_cacao_vivieroobservacion2', 'total_si')
    ...
    models = {
        ...
        u'guias_cacao.vivieroobservacion2': {
            ...
            'total_si': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
