...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VivieroObservacion1'
        db.create_table(u'guias_cacao_vivieroobservacion1', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('observacion1', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal(u'guias_cacao', ['VivieroObservacion1'])

        # Adding model 'FichaVivero'
        db.create_table(u'guias_cacao_fichavivero', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('productor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='persona_productor_vivero', to=orm['mapeo.Persona'])),
            ('tecnico', self.gf('django.db.models.fields.related.ForeignKey')(related_name='persona_tecnico_vivero', to=orm['mapeo.Persona'])),
            ('fecha_visita', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'guias_cacao', ['FichaVivero'])

        # Adding model 'VivieroObservacionProductos'
        db.create_table(u'guias_cacao_vivieroobservacionproductos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('producto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.ProductosVivero'])),
        ...
        db.send_create_signal(u'guias_cacao', ['VivieroObservacionProductos'])

        # Adding model 'ProductosVivero'
        db.create_table(u'guias_cacao_productosvivero', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'guias_cacao', ['ProductosVivero'])

        # Adding model 'VivieroAnalisisSituacion'
        db.create_table(u'guias_cacao_vivieroanalisissituacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('analisis1', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=5)),
            ('analisis2', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=11)),
            ('analisis3', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=15)),
            ('analisis4', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=11)),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaVivero'])),
        ))
        db.send_create_signal(u'guias_cacao', ['VivieroAnalisisSituacion'])

        # Adding model 'VivieroObservacion2'
        db.create_table(u'guias_cacao_vivieroobservacion2', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('observacion3', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('planta_6', self.gf('django.db.models.fields.IntegerField')()),
            ('planta_7', self.gf('django.db.models.fields.IntegerField')()),
            ('planta_8', self.gf('django.db.models.fields.IntegerField')()),
            ('planta_9', self.gf('django.db.models.fields.IntegerField')()),
            ('planta_10', self.gf('django.db.models.fields.IntegerField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaVivero'])),
        ))
        db.send_create_signal(u'guias_cacao', ['VivieroObservacion2'])

        # Adding model 'VivieroConversacion'
        db.create_table(u'guias_cacao_vivieroconversacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion1', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=23)),
            ...
            ('conversacion4', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=11)),
            ('conversacion5', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=9)),
            ('conversacion6', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('conversacion11', self.gf('django.db.models.fields.FloatField')()),
            ('conversacion12', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=5)),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaVivero'])),
        ))
        db.send_create_signal(u'guias_cacao', ['VivieroConversacion'])


        # Changing field 'Punto1Suelo.abonos'
        db.alter_column(u'guias_cacao_punto1suelo', 'abonos', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=13))

        # Changing field 'Punto1Suelo.orientacion'
        db.alter_column(u'guias_cacao_punto1suelo', 'orientacion', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=15))

    def backwards(self, orm):
        # Deleting model 'VivieroObservacion1'
        db.delete_table(u'guias_cacao_vivieroobservacion1')

        # Deleting model 'FichaVivero'
        db.delete_table(u'guias_cacao_fichavivero')

        # Deleting model 'VivieroObservacionProductos'
        db.delete_table(u'guias_cacao_vivieroobservacionproductos')

        # Deleting model 'ProductosVivero'
        db.delete_table(u'guias_cacao_productosvivero')

        # Deleting model 'VivieroAnalisisSituacion'
        db.delete_table(u'guias_cacao_vivieroanalisissituacion')

        # Deleting model 'VivieroObservacion2'
        db.delete_table(u'guias_cacao_vivieroobservacion2')

        # Deleting model 'VivieroConversacion'
        db.delete_table(u'guias_cacao_vivieroconversacion')


        # Changing field 'Punto1Suelo.abonos'
        db.alter_column(u'guias_cacao_punto1suelo', 'abonos', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=11))

        # Changing field 'Punto1Suelo.orientacion'
        db.alter_column(u'guias_cacao_punto1suelo', 'orientacion', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=13))
    ...
    models = {
        ...
        u'guias_cacao.vivieroconversacion': {
            ...
            'conversacion11': ('django.db.models.fields.FloatField', [], {}),
