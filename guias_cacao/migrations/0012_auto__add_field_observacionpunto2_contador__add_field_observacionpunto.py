...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservacionPunto2.contador'
        db.add_column(u'guias_cacao_observacionpunto2', 'contador',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto1.contador'
        db.add_column(u'guias_cacao_observacionpunto1', 'contador',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto3.contador'
        db.add_column(u'guias_cacao_observacionpunto3', 'contador',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservacionPunto2.contador'
        db.delete_column(u'guias_cacao_observacionpunto2', 'contador')

        # Deleting field 'ObservacionPunto1.contador'
        db.delete_column(u'guias_cacao_observacionpunto1', 'contador')

        # Deleting field 'ObservacionPunto3.contador'
        db.delete_column(u'guias_cacao_observacionpunto3', 'contador')
