...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FichaSaf'
        db.create_table(u'guias_cacao_fichasaf', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('productor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='persona_productor_saf', to=orm['mapeo.Persona'])),
            ('tecnico', self.gf('django.db.models.fields.related.ForeignKey')(related_name='persona_tecnico_saf', to=orm['mapeo.Persona'])),
            ('fecha_visita', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'guias_cacao', ['FichaSaf'])

        # Adding model 'SafConversacion9'
        db.create_table(u'guias_cacao_safconversacion9', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion17', self.gf('django.db.models.fields.IntegerField')()),
            ('conversacion18', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=11)),
            ('conversacion19', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=13)),
            ('conversacion20', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=13)),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion9'])

        # Adding model 'SafConversacion8'
        db.create_table(u'guias_cacao_safconversacion8', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion15', self.gf('django.db.models.fields.IntegerField')()),
            ('conversacion16', self.gf('django.db.models.fields.IntegerField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion8'])

        # Adding model 'SafConversacion5'
        db.create_table(u'guias_cacao_safconversacion5', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion7', self.gf('django.db.models.fields.IntegerField')()),
            ('conversacion8', self.gf('django.db.models.fields.IntegerField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion5'])

        # Adding model 'SafConversacion7'
        db.create_table(u'guias_cacao_safconversacion7', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion12', self.gf('django.db.models.fields.IntegerField')()),
            ('conversacion13', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=23)),
            ('conversacion14', self.gf('django.db.models.fields.IntegerField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion7'])

        # Adding model 'SafConversacion6'
        db.create_table(u'guias_cacao_safconversacion6', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion9', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=13)),
            ('conversacion10', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=11)),
            ('conversacion11', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=15)),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion6'])

        # Adding model 'SafConversacion3'
        db.create_table(u'guias_cacao_safconversacion3', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion3', self.gf('django.db.models.fields.IntegerField')()),
            ('conversacion4', self.gf('django.db.models.fields.IntegerField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion3'])

        # Adding model 'SafConversacion2'
        db.create_table(u'guias_cacao_safconversacion2', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion3', self.gf('django.db.models.fields.IntegerField')()),
            ('conversacion4', self.gf('django.db.models.fields.IntegerField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion2'])

        # Adding model 'SafConversacion4'
        db.create_table(u'guias_cacao_safconversacion4', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion5', self.gf('django.db.models.fields.IntegerField')()),
            ('conversacion6', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=23)),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion4'])

        # Adding model 'SafConversacion1'
        db.create_table(u'guias_cacao_safconversacion1', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversacion1', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=7)),
            ('conversacion2', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=15)),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafConversacion1'])

        # Adding model 'SafObservaciones4'
        db.create_table(u'guias_cacao_safobservaciones4', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('observacion8', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion9', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion10', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion11', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=11)),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafObservaciones4'])

        # Adding model 'SafObservaciones3'
        db.create_table(u'guias_cacao_safobservaciones3', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('observacion6', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion7', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=11)),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafObservaciones3'])

        # Adding model 'SafObservaciones2'
        db.create_table(u'guias_cacao_safobservaciones2', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('observacion1', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion2', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion3', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion4', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion5', self.gf('django.db.models.fields.IntegerField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafObservaciones2'])

        # Adding model 'SafObservaciones'
        db.create_table(u'guias_cacao_safobservaciones', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('observacion1', self.gf('django.db.models.fields.IntegerField')()),
            ('observacion2', self.gf('django.db.models.fields.FloatField')()),
            ('observacion3', self.gf('django.db.models.fields.FloatField')()),
            ('observacion4', self.gf('django.db.models.fields.FloatField')()),
            ('observacion5', self.gf('django.db.models.fields.FloatField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafObservaciones'])

        # Adding model 'SafObservacionPunto1'
        db.create_table(u'guias_cacao_safobservacionpunto1', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('especies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Especies'])),
            ('cantidad', self.gf('django.db.models.fields.FloatField')()),
            ('lena', self.gf('django.db.models.fields.FloatField')()),
            ('nutrientes', self.gf('django.db.models.fields.FloatField')()),
            ('frutas', self.gf('django.db.models.fields.FloatField')()),
            ('madera', self.gf('django.db.models.fields.FloatField')()),
            ('sombra', self.gf('django.db.models.fields.FloatField')()),
            ('ficha', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.FichaSaf'])),
        ))
        db.send_create_signal(u'guias_cacao', ['SafObservacionPunto1'])

        # Adding model 'SafObservacionPunto2'
        db.create_table(u'guias_cacao_safobservacionpunto2', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('especies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Especies'])),
            ('cantidad', self.gf('django.db.models.fields.FloatField')()),
            ('lena', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal(u'guias_cacao', ['SafObservacionPunto2'])

        # Adding model 'SafObservacionPunto3'
        db.create_table(u'guias_cacao_safobservacionpunto3', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('especies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Especies'])),
            ('cantidad', self.gf('django.db.models.fields.FloatField')()),
            ('lena', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal(u'guias_cacao', ['SafObservacionPunto3'])


    def backwards(self, orm):
        # Deleting model 'FichaSaf'
        db.delete_table(u'guias_cacao_fichasaf')

        # Deleting model 'SafConversacion9'
        db.delete_table(u'guias_cacao_safconversacion9')

        # Deleting model 'SafConversacion8'
        db.delete_table(u'guias_cacao_safconversacion8')

        # Deleting model 'SafConversacion5'
        db.delete_table(u'guias_cacao_safconversacion5')

        # Deleting model 'SafConversacion7'
        db.delete_table(u'guias_cacao_safconversacion7')

        # Deleting model 'SafConversacion6'
        db.delete_table(u'guias_cacao_safconversacion6')

        # Deleting model 'SafConversacion3'
        db.delete_table(u'guias_cacao_safconversacion3')

        # Deleting model 'SafConversacion2'
        db.delete_table(u'guias_cacao_safconversacion2')

        # Deleting model 'SafConversacion4'
        db.delete_table(u'guias_cacao_safconversacion4')

        # Deleting model 'SafConversacion1'
        db.delete_table(u'guias_cacao_safconversacion1')

        # Deleting model 'SafObservaciones4'
        db.delete_table(u'guias_cacao_safobservaciones4')

        # Deleting model 'SafObservaciones3'
        db.delete_table(u'guias_cacao_safobservaciones3')

        # Deleting model 'SafObservaciones2'
        db.delete_table(u'guias_cacao_safobservaciones2')

        # Deleting model 'SafObservaciones'
        db.delete_table(u'guias_cacao_safobservaciones')

        # Deleting model 'SafObservacionPunto1'
        db.delete_table(u'guias_cacao_safobservacionpunto1')

        # Deleting model 'SafObservacionPunto2'
        db.delete_table(u'guias_cacao_safobservacionpunto2')

        # Deleting model 'SafObservacionPunto3'
        db.delete_table(u'guias_cacao_safobservacionpunto3')
