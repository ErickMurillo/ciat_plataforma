...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservacionPunto3Nivel.alta'
        db.add_column(u'guias_cacao_observacionpunto3nivel', 'alta',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto3Nivel.media'
        db.add_column(u'guias_cacao_observacionpunto3nivel', 'media',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto3Nivel.baja'
        db.add_column(u'guias_cacao_observacionpunto3nivel', 'baja',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto1Nivel.alta'
        db.add_column(u'guias_cacao_observacionpunto1nivel', 'alta',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto1Nivel.media'
        db.add_column(u'guias_cacao_observacionpunto1nivel', 'media',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto1Nivel.baja'
        db.add_column(u'guias_cacao_observacionpunto1nivel', 'baja',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto2Nivel.alta'
        db.add_column(u'guias_cacao_observacionpunto2nivel', 'alta',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto2Nivel.media'
        db.add_column(u'guias_cacao_observacionpunto2nivel', 'media',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservacionPunto2Nivel.baja'
        db.add_column(u'guias_cacao_observacionpunto2nivel', 'baja',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservacionPunto3Nivel.alta'
        db.delete_column(u'guias_cacao_observacionpunto3nivel', 'alta')

        # Deleting field 'ObservacionPunto3Nivel.media'
        db.delete_column(u'guias_cacao_observacionpunto3nivel', 'media')

        # Deleting field 'ObservacionPunto3Nivel.baja'
        db.delete_column(u'guias_cacao_observacionpunto3nivel', 'baja')

        # Deleting field 'ObservacionPunto1Nivel.alta'
        db.delete_column(u'guias_cacao_observacionpunto1nivel', 'alta')

        # Deleting field 'ObservacionPunto1Nivel.media'
        db.delete_column(u'guias_cacao_observacionpunto1nivel', 'media')

        # Deleting field 'ObservacionPunto1Nivel.baja'
        db.delete_column(u'guias_cacao_observacionpunto1nivel', 'baja')

        # Deleting field 'ObservacionPunto2Nivel.alta'
        db.delete_column(u'guias_cacao_observacionpunto2nivel', 'alta')

        # Deleting field 'ObservacionPunto2Nivel.media'
        db.delete_column(u'guias_cacao_observacionpunto2nivel', 'media')

        # Deleting field 'ObservacionPunto2Nivel.baja'
        db.delete_column(u'guias_cacao_observacionpunto2nivel', 'baja')
    ...
    models = {
        ...
        u'guias_cacao.cosechapunto1': {
            ...
            'total_platas': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'guias_cacao.observacionpunto1nivel': {
            ...
            'alta': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'baja': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cinco': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cuatro': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'dies': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'dos': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ficha': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['guias_cacao.FichaPlaga']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'nueve': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ocho': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
