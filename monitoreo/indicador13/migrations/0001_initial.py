...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rubros'
        db.create_table(u'indicador13_rubros', (
        ...
        db.send_create_signal(u'indicador13', ['Rubros'])

        # Adding model 'IngresoFamiliar'
        db.create_table(u'indicador13_ingresofamiliar', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rubro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador13.Rubros'])),
        ...
        db.send_create_signal(u'indicador13', ['IngresoFamiliar'])

        # Adding model 'IngresoEntrevistada'
        db.create_table(u'indicador13_ingresoentrevistada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rubro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador13.Rubros'])),
            ('cantidad', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('precio', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'indicador13', ['IngresoEntrevistada'])


    def backwards(self, orm):
        # Deleting model 'Rubros'
        db.delete_table(u'indicador13_rubros')

        # Deleting model 'IngresoFamiliar'
        db.delete_table(u'indicador13_ingresofamiliar')

        # Deleting model 'IngresoEntrevistada'
        db.delete_table(u'indicador13_ingresoentrevistada')
    ...
    models = {
        ...
        u'indicador13.ingresoentrevistada': {
            'Meta': {'object_name': 'IngresoEntrevistada'},
            ...
            'rubro': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador13.Rubros']"})
        },
        u'indicador13.ingresofamiliar': {
