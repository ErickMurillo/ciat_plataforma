...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'indicador10_manejoagro', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('unidad', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'indicador10', ['ManejoAgro'])

        # Adding model 'OpcionesManejo'
        db.create_table(u'indicador10_opcionesmanejo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador10.ManejoAgro'])),
        ...
        db.send_create_signal(u'indicador10', ['OpcionesManejo'])


    def backwards(self, orm):
        # Deleting model 'ManejoAgro'
        db.delete_table(u'indicador10_manejoagro')

        # Deleting model 'OpcionesManejo'
        db.delete_table(u'indicador10_opcionesmanejo')
    ...
    models = {
        ...
        u'indicador10.opcionesmanejo': {
            ...
            'uso': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador10.ManejoAgro']"}),
