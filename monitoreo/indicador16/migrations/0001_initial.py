...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'indicador16_ahorropregunta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'indicador16', ['AhorroPregunta'])

        # Adding model 'Ahorro'
        db.create_table(u'indicador16_ahorro', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ahorro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador16.AhorroPregunta'])),
        ...
        db.send_create_signal(u'indicador16', ['Ahorro'])

        # Adding model 'AhorroEntrevista'
        db.create_table(u'indicador16_ahorroentrevista', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ahorro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador16.AhorroPregunta'])),
            ('respuesta', self.gf('django.db.models.fields.IntegerField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitoreo.Encuesta'])),
        ))
        db.send_create_signal(u'indicador16', ['AhorroEntrevista'])


    def backwards(self, orm):
        # Deleting model 'AhorroPregunta'
        db.delete_table(u'indicador16_ahorropregunta')

        # Deleting model 'Ahorro'
        db.delete_table(u'indicador16_ahorro')

        # Deleting model 'AhorroEntrevista'
        db.delete_table(u'indicador16_ahorroentrevista')
    ...
    models = {
        ...
        u'indicador16.ahorro': {
            'Meta': {'object_name': 'Ahorro'},
            'ahorro': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador16.AhorroPregunta']"}),
        ...
        u'indicador16.ahorroentrevista': {
            'Meta': {'object_name': 'AhorroEntrevista'},
            'ahorro': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador16.AhorroPregunta']"}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitoreo.Encuesta']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'respuesta': ('django.db.models.fields.IntegerField', [], {})
        },
        u'indicador16.ahorropregunta': {
