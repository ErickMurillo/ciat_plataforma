...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'indicador20_preguntariesgo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'indicador20', ['PreguntaRiesgo'])

        # Adding model 'Riesgos'
        db.create_table(u'indicador20_riesgos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'indicador20', ['Riesgos'])


    def backwards(self, orm):
        # Deleting model 'PreguntaRiesgo'
        db.delete_table(u'indicador20_preguntariesgo')

        # Deleting model 'Riesgos'
        db.delete_table(u'indicador20_riesgos')
    ...
    models = {
        ...
        u'indicador20.preguntariesgo': {
            'Meta': {'object_name': 'PreguntaRiesgo'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'indicador20.riesgos': {
            'Meta': {'object_name': 'Riesgos'},
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitoreo.Encuesta']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pregunta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador20.PreguntaRiesgo']"}),
