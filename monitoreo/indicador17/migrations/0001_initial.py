...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'indicador17_dacredito', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'indicador17', ['DaCredito'])

        # Adding model 'OcupaCredito'
        db.create_table(u'indicador17_ocupacredito', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'indicador17', ['OcupaCredito'])

        # Adding model 'Credito'
        db.create_table(u'indicador17_credito', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'indicador17', ['Credito'])

        # Adding M2M table for field quien_credito on 'Credito'
        m2m_table_name = db.shorten_name(u'indicador17_credito_quien_credito')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('credito', models.ForeignKey(orm[u'indicador17.credito'], null=False)),
            ('dacredito', models.ForeignKey(orm[u'indicador17.dacredito'], null=False))
        ))
        db.create_unique(m2m_table_name, ['credito_id', 'dacredito_id'])

        # Adding M2M table for field ocupa_credito on 'Credito'
        m2m_table_name = db.shorten_name(u'indicador17_credito_ocupa_credito')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('credito', models.ForeignKey(orm[u'indicador17.credito'], null=False)),
            ('ocupacredito', models.ForeignKey(orm[u'indicador17.ocupacredito'], null=False))
        ))
        db.create_unique(m2m_table_name, ['credito_id', 'ocupacredito_id'])

        # Adding model 'CreditoEntrevista'
        db.create_table(u'indicador17_creditoentrevista', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recibe', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('desde', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('satisfaccion', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'indicador17', ['CreditoEntrevista'])

        # Adding M2M table for field quien_credito on 'CreditoEntrevista'
        m2m_table_name = db.shorten_name(u'indicador17_creditoentrevista_quien_credito')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('creditoentrevista', models.ForeignKey(orm[u'indicador17.creditoentrevista'], null=False)),
            ('dacredito', models.ForeignKey(orm[u'indicador17.dacredito'], null=False))
        ))
        db.create_unique(m2m_table_name, ['creditoentrevista_id', 'dacredito_id'])

        # Adding M2M table for field ocupa_credito on 'CreditoEntrevista'
        m2m_table_name = db.shorten_name(u'indicador17_creditoentrevista_ocupa_credito')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('creditoentrevista', models.ForeignKey(orm[u'indicador17.creditoentrevista'], null=False)),
            ('ocupacredito', models.ForeignKey(orm[u'indicador17.ocupacredito'], null=False))
        ))
        db.create_unique(m2m_table_name, ['creditoentrevista_id', 'ocupacredito_id'])


    def backwards(self, orm):
        # Deleting model 'DaCredito'
        db.delete_table(u'indicador17_dacredito')

        # Deleting model 'OcupaCredito'
        db.delete_table(u'indicador17_ocupacredito')

        # Deleting model 'Credito'
        db.delete_table(u'indicador17_credito')

        # Removing M2M table for field quien_credito on 'Credito'
        db.delete_table(db.shorten_name(u'indicador17_credito_quien_credito'))

        # Removing M2M table for field ocupa_credito on 'Credito'
        db.delete_table(db.shorten_name(u'indicador17_credito_ocupa_credito'))

        # Deleting model 'CreditoEntrevista'
        db.delete_table(u'indicador17_creditoentrevista')

        # Removing M2M table for field quien_credito on 'CreditoEntrevista'
        db.delete_table(db.shorten_name(u'indicador17_creditoentrevista_quien_credito'))

        # Removing M2M table for field ocupa_credito on 'CreditoEntrevista'
        db.delete_table(db.shorten_name(u'indicador17_creditoentrevista_ocupa_credito'))
    ...
    models = {
        ...
        u'indicador17.credito': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ocupa_credito': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['indicador17.OcupaCredito']", 'null': 'True', 'blank': 'True'}),
            'quien_credito': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['indicador17.DaCredito']", 'null': 'True', 'blank': 'True'}),
        ...
        u'indicador17.creditoentrevista': {
            'Meta': {'object_name': 'CreditoEntrevista'},
            'desde': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'dia': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitoreo.Encuesta']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'indicador17.dacredito': {
            'Meta': {'object_name': 'DaCredito'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'indicador17.ocupacredito': {
