...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Uso'
        db.create_table(u'indicador05_uso', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'indicador05', ['Uso'])

        # Adding model 'UsoTierra'
        db.create_table(u'indicador05_usotierra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tierra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador05.Uso'])),
        ...
        db.send_create_signal(u'indicador05', ['UsoTierra'])

        # Adding model 'UsoTierraEntrevistada'
        db.create_table(u'indicador05_usotierraentrevistada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tierra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador05.Uso'])),
            ('area', self.gf('django.db.models.fields.FloatField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitoreo.Encuesta'])),
        ))
        db.send_create_signal(u'indicador05', ['UsoTierraEntrevistada'])


    def backwards(self, orm):
        # Deleting model 'Uso'
        db.delete_table(u'indicador05_uso')

        # Deleting model 'UsoTierra'
        db.delete_table(u'indicador05_usotierra')

        # Deleting model 'UsoTierraEntrevistada'
        db.delete_table(u'indicador05_usotierraentrevistada')
    ...
    models = {
        ...
        u'indicador05.usotierra': {
            'Meta': {'object_name': 'UsoTierra'},
            'area': ('django.db.models.fields.FloatField', [], {}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitoreo.Encuesta']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tierra': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador05.Uso']"})
        },
        u'indicador05.usotierraentrevistada': {
            'Meta': {'object_name': 'UsoTierraEntrevistada'},
            'area': ('django.db.models.fields.FloatField', [], {}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitoreo.Encuesta']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tierra': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador05.Uso']"})
