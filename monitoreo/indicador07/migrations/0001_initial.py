...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'indicador07_actividad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'indicador07', ['Actividad'])

        # Adding model 'Reforestacion'
        db.create_table(u'indicador07_reforestacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reforestacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador07.Actividad'])),
        ...
        db.send_create_signal(u'indicador07', ['Reforestacion'])


    def backwards(self, orm):
        # Deleting model 'Actividad'
        db.delete_table(u'indicador07_actividad')

        # Deleting model 'Reforestacion'
        db.delete_table(u'indicador07_reforestacion')
