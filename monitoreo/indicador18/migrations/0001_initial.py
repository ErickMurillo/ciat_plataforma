...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'indicador18_alimentos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('categoria', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'indicador18', ['Alimentos'])

        # Adding model 'Seguridad'
        db.create_table(u'indicador18_seguridad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alimento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador18.Alimentos'])),
        ...
        db.send_create_signal(u'indicador18', ['Seguridad'])


    def backwards(self, orm):
        # Deleting model 'Alimentos'
        db.delete_table(u'indicador18_alimentos')

        # Deleting model 'Seguridad'
        db.delete_table(u'indicador18_seguridad')
