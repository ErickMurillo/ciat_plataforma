...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'indicador14_fuentes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'indicador14', ['Fuentes'])

        # Adding model 'TipoTrabajo'
        db.create_table(u'indicador14_tipotrabajo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'indicador14', ['TipoTrabajo'])

        # Adding model 'OtrosIngresos'
        db.create_table(u'indicador14_otrosingresos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'indicador14', ['OtrosIngresos'])


    def backwards(self, orm):
        # Deleting model 'Fuentes'
        db.delete_table(u'indicador14_fuentes')

        # Deleting model 'TipoTrabajo'
        db.delete_table(u'indicador14_tipotrabajo')

        # Deleting model 'OtrosIngresos'
        db.delete_table(u'indicador14_otrosingresos')
    ...
    models = {
        ...
        u'indicador14.otrosingresos': {
            ...
            'tipo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador14.TipoTrabajo']"})
        },
        u'indicador14.tipotrabajo': {
