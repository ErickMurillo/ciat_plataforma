...
urlpatterns = patterns('monitoreo.monitoreo.views',
    ...
    url(r'^linea-base/$', HomePageViewfail.as_view(), name='linea_base'),
    #(r'^$', 'index'),
    url(r'^index/$', 'inicio', name='index'),
    url(r'^index/linea/$', 'inicio_linea', name='index_linea'),
    ...
    url(r'^grafo/ingreso/entre/(?P<tipo>\w+)/$', 'grafos_ingreso_entre', name='grafos-ingreso-entre'),
    ...
    url(r'^grafo/ahorro-credito/entre/(?P<tipo>\w+)/$', 'ahorro_credito_grafos_entre', 
                                            name='ahorro-credito-grafos'),
    url(r'^mapa/$', 'obtener_lista', name='obtener-lista'),
    url(r'^mapa/linea/$', 'obtener_lista_linea', name='obtener-lista-linea'),
