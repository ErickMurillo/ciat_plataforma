...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'monitoreo_recolector', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'monitoreo', ['Recolector'])

        # Adding model 'Encuesta'
        db.create_table(u'monitoreo_encuesta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('recolector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitoreo.Recolector'])),
            ...
            ('tipo_encuesta', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'monitoreo', ['Encuesta'])

        # Adding model 'Tenencia'
        db.create_table(u'monitoreo_tenencia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'monitoreo', ['Tenencia'])

        # Adding model 'TenenciaEntrevistada'
        db.create_table(u'monitoreo_tenenciaentrevistada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parcela', self.gf('django.db.models.fields.IntegerField')()),
            ('solar', self.gf('django.db.models.fields.IntegerField')()),
            ('dueno', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'monitoreo', ['TenenciaEntrevistada'])

        # Adding model 'CasaSolar'
        db.create_table(u'monitoreo_casasolar', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('casa', self.gf('django.db.models.fields.IntegerField')()),
            ('tenencia', self.gf('django.db.models.fields.IntegerField')()),
            ('dueno', self.gf('django.db.models.fields.IntegerField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitoreo.Encuesta'])),
        ))
        db.send_create_signal(u'monitoreo', ['CasaSolar'])


    def backwards(self, orm):
        # Deleting model 'Recolector'
        db.delete_table(u'monitoreo_recolector')

        # Deleting model 'Encuesta'
        db.delete_table(u'monitoreo_encuesta')

        # Deleting model 'Tenencia'
        db.delete_table(u'monitoreo_tenencia')

        # Deleting model 'TenenciaEntrevistada'
        db.delete_table(u'monitoreo_tenenciaentrevistada')

        # Deleting model 'CasaSolar'
        db.delete_table(u'monitoreo_casasolar')
