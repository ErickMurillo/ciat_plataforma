...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'indicador09_cultivos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('unidad', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'indicador09', ['Cultivos'])

        # Adding model 'CultivosFinca'
        db.create_table(u'indicador09_cultivosfinca', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cultivos', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicador09.Cultivos'])),
            ...
            ('productivos', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'indicador09', ['CultivosFinca'])


    def backwards(self, orm):
        # Deleting model 'Cultivos'
        db.delete_table(u'indicador09_cultivos')

        # Deleting model 'CultivosFinca'
        db.delete_table(u'indicador09_cultivosfinca')
    ...
    models = {
        ...
        u'indicador09.cultivos': {
            'Meta': {'ordering': "['nombre']", 'object_name': 'Cultivos'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'unidad': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'indicador09.cultivosfinca': {
            'Meta': {'object_name': 'CultivosFinca'},
            'area': ('django.db.models.fields.FloatField', [], {}),
            'consumo': ('django.db.models.fields.FloatField', [], {}),
            'cultivos': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['indicador09.Cultivos']"}),
