...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CultivosFinca.quien'
        db.add_column(u'indicador09_cultivosfinca', 'quien',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CultivosFinca.quien'
        db.delete_column(u'indicador09_cultivosfinca', 'quien')
    ...
    models = {
        ...
        u'indicador09.cultivosfinca': {
            ...
            'quien': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
