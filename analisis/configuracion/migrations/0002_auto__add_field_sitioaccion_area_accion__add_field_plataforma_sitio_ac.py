...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SitioAccion.area_accion'
        db.add_column(u'configuracion_sitioaccion', 'area_accion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['configuracion.AreaAccion']),
                      keep_default=False)

        # Adding field 'Plataforma.sitio_accion'
        db.add_column(u'configuracion_plataforma', 'sitio_accion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['configuracion.SitioAccion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SitioAccion.area_accion'
        db.delete_column(u'configuracion_sitioaccion', 'area_accion_id')

        # Deleting field 'Plataforma.sitio_accion'
        db.delete_column(u'configuracion_plataforma', 'sitio_accion_id')
