...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entrevista.pais'
        db.add_column(u'analisis_entrevista', 'pais',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lugar.Pais']),
                      keep_default=False)


        # Changing field 'Entrevista.departamento'
        db.alter_column(u'analisis_entrevista', 'departamento_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['lugar.Departamento']))
        # Deleting field 'Pregunta_11.tipo_estudio'
        db.delete_column(u'analisis_pregunta_11', 'tipo_estudio_id')

        # Adding field 'Pregunta_11.tipo_estudio1'
        db.add_column(u'analisis_pregunta_11', 'tipo_estudio1',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entrevista.pais'
        db.delete_column(u'analisis_entrevista', 'pais_id')


        # Changing field 'Entrevista.departamento'
        db.alter_column(u'analisis_entrevista', 'departamento_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lugar.Departamento']))
        # Adding field 'Pregunta_11.tipo_estudio'
        db.add_column(u'analisis_pregunta_11', 'tipo_estudio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['configuracion.Tipo_Estudio']),
                      keep_default=False)

        # Deleting field 'Pregunta_11.tipo_estudio1'
        db.delete_column(u'analisis_pregunta_11', 'tipo_estudio1')
