...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entrevista.departamento'
        db.delete_column(u'analisis_entrevista', 'departamento_id')
    ...
    def backwards(self, orm):
        # Adding field 'Entrevista.departamento'
        db.add_column(u'analisis_entrevista', 'departamento',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(default=1, to=orm['lugar.Departamento']),
                      keep_default=False)
