...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Biblioteca.palabras_claves'
        db.add_column(u'biblioteca_biblioteca', 'palabras_claves',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Biblioteca.palabras_claves'
        db.delete_column(u'biblioteca_biblioteca', 'palabras_claves')
