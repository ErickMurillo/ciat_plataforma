...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Biblioteca.anio'
        db.add_column(u'biblioteca_biblioteca', 'anio',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Biblioteca.cita'
        db.add_column(u'biblioteca_biblioteca', 'cita',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field proyecto on 'Biblioteca'
        m2m_table_name = db.shorten_name(u'biblioteca_biblioteca_proyecto')
        ...
        db.create_unique(m2m_table_name, ['biblioteca_id', 'proyectos_id'])

        # Adding M2M table for field alianza on 'Biblioteca'
        m2m_table_name = db.shorten_name(u'biblioteca_biblioteca_alianza')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('biblioteca', models.ForeignKey(orm[u'biblioteca.biblioteca'], null=False)),
            ('plataforma', models.ForeignKey(orm[u'configuracion.plataforma'], null=False))
        ))
        db.create_unique(m2m_table_name, ['biblioteca_id', 'plataforma_id'])


    def backwards(self, orm):
        # Deleting field 'Biblioteca.anio'
        db.delete_column(u'biblioteca_biblioteca', 'anio')

        # Deleting field 'Biblioteca.cita'
        db.delete_column(u'biblioteca_biblioteca', 'cita')

        # Removing M2M table for field proyecto on 'Biblioteca'
        db.delete_table(db.shorten_name(u'biblioteca_biblioteca_proyecto'))

        # Removing M2M table for field alianza on 'Biblioteca'
        db.delete_table(db.shorten_name(u'biblioteca_biblioteca_alianza'))
    ...
    models = {
        ...
        u'biblioteca.biblioteca': {
            ...
            'alianza': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['configuracion.Plataforma']", 'symmetrical': 'False', 'blank': 'True'}),
            'anio': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'autor': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'cita': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'palabras_claves': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
