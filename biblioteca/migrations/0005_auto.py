...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field temas on 'Biblioteca'
        m2m_table_name = db.shorten_name(u'biblioteca_biblioteca_temas')
        ...
        db.create_unique(m2m_table_name, ['biblioteca_id', 'temas_id'])


    def backwards(self, orm):
        # Removing M2M table for field temas on 'Biblioteca'
        db.delete_table(db.shorten_name(u'biblioteca_biblioteca_temas'))
