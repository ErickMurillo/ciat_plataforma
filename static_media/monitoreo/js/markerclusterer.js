...
/*******************Agregado en la necesidad de hover del mouse**************************/
//var infowindow = null;
//var boxText = document.createElement("div");
//boxText.style.cssText = "border: 1px solid #92B900; margin-top: 8px; background:#ffffff; padding: 5px;  overflow: auto; height: 70px ";

//var myOptions = "";

//ClusterIcon.prototype.triggerClusterOver = function() {
//    foo = "<div class='infobox'><ul>";
//    for(i=0; i < this.cluster_.markers_.length; i++) {
//        foo = foo + "<li><a href='/mapeo/ficha/"+ this.cluster_.markers_[i].item + "/" + this.cluster_.markers_[i].id + "'>"+this.cluster_.markers_[i].title+'</a></li>';
//    }
//    foo = foo + "</ul></div>"  ;
...
//        google.maps.event.addDomListener(infowindow, 'closeclick', function(evt) {
//            this.setContent('');
//        });
//    }
...
ClusterIcon.prototype.onAdd = function() {
    ...
    // Evento de mouse over en la necesidad de listar las shits
